...
<body>
        ...
        <div class="auction">
            ...
            <div class="nft">
                <div class=item>
                    ...
                    <button class="truck-button" style="margin-top: 20px; margin-left: 15px;"  id="EcoNatura" onclick="FashionFusionHQSuma()">
                ...
                <div class=item>
                    ...
                    <!-- Apartado de añadir al carrito -->
                    <button class="truck-button" style="margin-top: 20px; margin-left: 15px; bor"  id="TechGizmos" onclick="MindfulMeditatorSuma()">
                        <span class="default">Añadir a la cesta</span>
                        <span class="success">
                            Exito
                            <svg viewbox="0 0 12 10">
                ...
                <div class=item>
                    ...
                    <!-- Apartado de añadir al carrito -->
                    <button class="truck-button" style="margin-top: 20px; margin-left: 15px; bor"  id="HealthyLivingHub" onclick="CulinaryCraftsmenSuma()">
                        <span class="default">Añadir a la cesta</span>
                        <span class="success">
                            Exito
                            <svg viewbox="0 0 12 10">
                ...
                <div class=item>
                    ...
                    <!-- Apartado de añadir al carrito -->
                    <button class="truck-button" style="margin-top: 20px; margin-left: 15px; bor"  id="TravelVoyagePro" onclick="ArtisanCraftersSuma()">
                        <span class="default">Añadir a la cesta</span>
                        <span class="success">
                            Exito
                            <svg viewbox="0 0 12 10">
  ...
  <span id="CulinaryCraftsmenContadorDiv"></span>
  <span id="ArtisanCraftersContadorDiv"></span>
  <span id="totalImpuestos">0</span>
  <span id="totalCompleto">0</span>
    </div>
